...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'DemoTrack',
        short_name: 'DemoTrack',
        description: 'Your silent manager. Ship your music.',
        theme_color: '#0b0b0f',
        background_color: '#0b0b0f',
        display: 'standalone',
        orientation: 'portrait',
        start_url: '/',
        // SVG icon ships in Phase 1; rasterized PNG/maskable icons land with the
        // design pass (frontend-builder).
        icons: [
